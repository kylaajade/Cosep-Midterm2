...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->Password = 'uwmx zmvm ovnf cduc'; // SMTP password
            ...
            $mail->Body    = 'Click the link to verify your account: <a href="http://localhost/hehheh_mid/verify.php?code=' . $verification_code . '">Verify Account</a>';
